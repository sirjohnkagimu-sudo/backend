                  ...
                  <td>
                    <div class="container">
                      ...
                      <div class="content">
                        ...
                        <div class="message">
                          <p>Hello <strong><?php echo e($school->admin_name); ?></strong>,</p>
                        ...
                        <div class="school-details">
                          ...
                          <div class="detail-row">
                            ...
                            <span class="detail-value"><?php echo e($school->name); ?></span>
                          </div>
                          <div class="detail-row">
                            <span class="detail-label">Centre Number:</span>
                            <span class="detail-value">  <?php echo e($school->centre_number); ?></span>
                          </div>
                          <div class="detail-row">
                            <span class="detail-label">District:</span>
                            <span class="detail-value">  <?php echo e($school->district); ?></span>
                          </div>
                          <div class="detail-row">
                            <span class="detail-label">Registration Date:</span>
                            <span class="detail-value"><?php echo e($school->created_at->format('F j, Y')); ?></span>
                          </div>
                        </div>
                        ...
                        <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="text-align:center;margin:30px 0">
                          <tbody>
                            <tr>
                              <td>
                                <a href="<?php echo e(url('/login')); ?>" class="cta-button" target="_blank">
...
<?php /**PATH C:\Projects\backend\resources\views/emails/school_registration_confirmation.blade.php ENDPATH**/ ?>