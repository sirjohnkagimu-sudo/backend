...
<head>
    ...
    <!-- Title -->
    <title>EDUMALL | <?php echo e(session('title')); ?></title>
        ...
        <div class="page-main">
            ...
            <aside class="app-sidebar app-sidebar3">
                ...
                <ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('labs.index')); ?>">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('web.schools.all')); ?>">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="<?php echo e(route('orders.index')); ?>">
                                        ...
                                        <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                            <span>
                                                <?php if(Auth::check() && Auth::user()->image): ?>
                                                    <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="img" style="height: 60px; width:60px;">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('images/placeholder.png')); ?>" alt="img" style="height: 60px; width:60px;">
                                                <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('logout'),'onclick' => 'event.preventDefault();
                                                this.closest(\'form\').submit();','class' => 'dropdown-item d-flex']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
                        Copyright © 2026 <a href="#"><?php echo e(config('app.name')); ?></a>. Designed by <a href="#">Sir JayP</a>
                        All rights reserved.
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Projects\backend\resources\views/layouts/master.blade.php ENDPATH**/ ?>